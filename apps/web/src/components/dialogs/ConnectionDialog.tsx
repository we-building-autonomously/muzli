...
const DB_CONFIGS = {
  ...
  mongodb: {
    ...
    icon: "🍃",
    defaultPort: 27017,
    hostLabel: "Connection String",
    hostPlaceholder: "mongodb+srv://user:pass@cluster.mongodb.net/mydb",
    databaseLabel: "Database",
    databasePlaceholder: "mydb (optional if in connection string)",
    usernamePlaceholder: "",
    showHost: true,
    showPort: false,
    showDatabase: true,
...
export function ConnectionDialog({
  ...
  const handleTypeChange = (type: DbType) => {
    ...
    setFormData((prev) => ({
      ...
      host: type === "sqlite" || type === "pinecone" || type === "mongodb" ? "" : type === "turbopuffer" ? "gcp-us-central1" : "localhost",
      username: "",
      password: "",
      database: "",
